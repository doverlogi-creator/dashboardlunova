...
export default function EventTable({ events, settings, onDeleteEvent }: EventTableProps) {
    ...
    <div className="bg-zinc-900 border border-zinc-800 rounded-2xl overflow-hidden flex flex-col">
      ...
      <div className="p-6 border-b border-zinc-800 bg-zinc-900/60 space-y-4">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <h3 className="text-base font-bold text-zinc-100">Daftar Transaksi Pengisian Data</h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="Cari Vendor, Paket, Lokasi..."
          ...
          <div>
            ...
            >
              <option value="all">Semua Vendor/WO</option>
              {uniqueVendors.map((v) => (
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="border-b border-zinc-800 bg-zinc-950/30 text-[10px] font-bold text-zinc-400 uppercase tracking-wider">
              ...
              <th className="py-3.5 px-4">Vendor / WO</th>
              <th className="py-3.5 px-4 hidden md:table-cell">Lokasi</th>
              <th className="py-3.5 px-4 text-right">Pemasukan</th>
              <th className="py-3.5 px-4 text-right">Keuntungan Bersih</th>
            ...
            {filteredEvents.length > 0 ? (
                  ...
                  <tr key={evt.id} className="hover:bg-zinc-950/40 transition-colors group">
                    ...
                    >
                      <div className="flex items-center gap-1.5 min-w-[90px]">
                        ...
                        <span>{formatDateIndo(evt.tanggal)}</span>
                      </div>
                    </td>
                    ...
                    <td className="py-4 px-6 text-center">
                      <div className="flex items-center justify-center gap-2">
                        ...
                        {onDeleteEvent && (
                          <button
                            onClick={() => {
                              if (window.confirm("Apakah Anda yakin ingin menghapus transaksi sewa ini?")) {
              ...
              <tr>
                <td colSpan={7} className="text-center py-10 text-zinc-500 font-medium font-mono">
                  Tidak ada data yang cocok dengan pencarian Anda. Try resetting search filters.
                </td>
              </tr>
            )}
          </tbody>
            ...
            <div className="relative bg-zinc-900 border border-zinc-800 rounded-2xl w-full max-w-2xl overflow-hidden shadow-2xl flex flex-col animate-scaleUp">
              ...
              <div className="px-6 py-4 border-b border-zinc-800 flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    <h3 className="text-sm font-bold text-zinc-100">Detail Transaksi Persewaan</h3>
                    <p className="text-[10px] text-zinc-500">Rincian pengeluaran operasional dan distribusi alokasi laba</p>
                  </div>
                </div>
                <button
                  onClick={() => setSelectedDetailEvent(null)}
              ...
              <div className="p-6 space-y-5 overflow-y-auto max-h-[75vh]">
                ...
                <div className="bg-zinc-950/60 p-4 border border-zinc-800 rounded-xl">
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-xs">
                    <div>
                      <span className="text-[9px] uppercase font-bold text-zinc-500 block mb-1">Tanggal Acara</span>
                      <span className="text-zinc-200 font-semibold font-mono flex items-center gap-1">
                        <Calendar className="w-3.5 h-3.5 text-zinc-500 shrink-0" />
                        {formatDateIndo(selectedDetailEvent.tanggal)}
                      </span>
                    </div>
                    <div>
                      <span className="text-[9px] uppercase font-bold text-zinc-500 block mb-1">Jenis Paket Jasa</span>
                    ...
                    <div>
                      <span className="text-[9px] uppercase font-bold text-zinc-500 block mb-1">Nama Vendor / WO</span>
                      <span className="text-blue-400 font-bold font-mono block truncate">
                        {selectedDetailEvent.vendor}
                      </span>
                    </div>
                    <div>
                      <span className="text-[9px] uppercase font-bold text-zinc-500 block mb-1">Pemasukan Kotor</span>
                  ...
                  <div className="bg-zinc-900 border border-zinc-800 p-4 rounded-xl flex flex-col justify-between">
                    <div>
                      ...
                      <div className="space-y-3 mt-3 text-xs">
                        <div>
                          <span className="block font-semibold text-zinc-400 uppercase tracking-wider text-[9px] mb-0.5">Lokasi Gedung / Acara:</span>
                          <span className="text-zinc-250 font-mono leading-relaxed">{selectedDetailEvent.lokasi}</span>
                        </div>
                        <div>
                          <span className="block font-semibold text-zinc-400 uppercase tracking-wider text-[9px] mb-0.5">Kontak WhatsApp:</span>
                          {selectedDetailEvent.noHp && selectedDetailEvent.noHp !== "-" ? (
                            ...
                            <span className="text-zinc-500 font-mono italic mt-0.5 inline-block">Tidak ada kontak</span>
                          )}
                        </div>
                      </div>
                    </div>
                ...
                <div className="bg-zinc-950/40 border border-zinc-800 rounded-xl p-5 space-y-4">
                  <div className="flex items-center justify-between border-b border-zinc-800/60 pb-3">
                    <div className="flex flex-col">
                      <span className="text-xs font-bold text-blue-400 uppercase tracking-wider">Hasil Keuntungan Bersih (Laba)</span>
                      <span className="text-[9px] text-zinc-500 mt-0.5">Rumus: Pemasukan - Total Pengeluaran</span>
                    </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    ...
                    <div className="bg-purple-950/15 border border-purple-900/40 rounded-xl p-3.5 space-y-1.5">
                      ...
                      <div className="flex items-baseline gap-1">
                        ...
                        <span className="text-[10px] text-zinc-600">Bagi Hasil</span>
                      </div>
                    ...
                    <div className="bg-cyan-950/15 border border-cyan-900/40 rounded-xl p-3.5 space-y-1.5">
                      ...
                      <div className="flex items-baseline gap-1">
                        ...
                        <span className="text-[10px] text-zinc-600">Terakumulasi</span>
                      </div>
